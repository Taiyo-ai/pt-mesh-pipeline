...
class EPIStandardiser:
    def __init__(self, **kwargs):
        ...
        self.metadata = Metadata(name="epilatc", bucket="taiyo-projects", aws=False)
    ...
    def generate_metadata(self):
        ...
        self.metadata.create_metadata(
            ...
            source="eProcurements India Latest Active Central Tenders",
            source_abbr="EPILATC",
            ...
            frequency="daily",
            dataset_type="T",
            indicatorfile="indicators_epilatc.json",
