...
class EPIStandardiser:
    def __init__(self, **kwargs):
        ...
        self.metadata = Metadata(name="epicans", bucket="taiyo-projects", aws=False)
    ...
    def generate_metadata(self):
        ...
        self.metadata.create_metadata(
            ...
            source="eProcurements India Cancelled State Tenders",
            source_abbr="EPICANS",
            ...
            frequency="daily",
            dataset_type="P",
            indicatorfile="indicators_epicans.json",
