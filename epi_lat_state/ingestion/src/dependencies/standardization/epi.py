...
class EPIStandardiser:
    def __init__(self, **kwargs):
        ...
        self.metadata = Metadata(name="epilats", bucket="taiyo-projects", aws=False)
    ...
    def generate_metadata(self):
        ...
        self.metadata.create_metadata(
            ...
            source="eProcurements India Latest Active State Tenders",
            source_abbr="EPILATS",
            ...
            frequency="daily",
            dataset_type="T",
            indicatorfile="indicators_epilats.json",
