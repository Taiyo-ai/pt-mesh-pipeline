...
class IIGMetadataScraper:
    ...
    def create_page_url_list(self):
        enum = ["csr-projects"]
        type = "csr-projects"
        BASE_URL = "https://indiainvestmentgrid.gov.in/opportunities/csr-projects"
        ...
        try:
            ...
            active_sectors = sector_list_wrapper.find_all("li", {"class": ["active"]})
            ...
            urls = []
            url = ""
            TEMPLATE_URL = f"https://indiainvestmentgrid.gov.in/opportunities/{type}/"
