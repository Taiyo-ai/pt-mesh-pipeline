...
from dependencies.scraping.eProcIndHVTState import EPIHighValueStateTendersScraper
...
def step_2():
    extra_config = {"source_abbr": "EPIHVTS"}
...
def step_5():
    ...
    logging.info("Elastic Search Data Ingestion Done")
