...
class EPIStandardiser:
    def __init__(self, **kwargs):
        ...
        self.metadata = Metadata(name="epihvts", bucket="taiyo-projects", aws=False)
    ...
    def generate_metadata(self):
        ...
        self.metadata.create_metadata(
            ...
            source="eProcurements India High Value State Tenders",
            source_abbr="EPIHVTS",
            ...
            frequency="daily",
            dataset_type="T",
            indicatorfile="indicators_epihvts.json",
