...
class EPIStandardiser:
    def __init__(self, **kwargs):
        ...
        self.metadata = Metadata(name="epicanc", bucket="taiyo-projects", aws=False)
    ...
    def rename_columns(self, df: pd.core.frame.DataFrame):
        renaming_dict = {
            ...
            "tender_document_link": "tender_document_link",
    ...
    def typecast_df(self, df: pd.core.frame.DataFrame) -> pd.core.frame.DataFrame:
        ...
        df["tender_document_link"] = df["tender_document_link"].astype(str)
    ...
    def generate_metadata(self):
        ...
        self.metadata.create_metadata(
            ...
            source="eProcurements India Cancelled Central Tenders",
            source_abbr="EPICANC",
            ...
            frequency="daily",
            dataset_type="P",
            indicatorfile="indicators_epicanc.json",
